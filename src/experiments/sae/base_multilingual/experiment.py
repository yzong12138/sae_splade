...
from utils.datasets import mmarco_documents
...
def run(
    ...
    # for training
    documents_list = mmarco_documents(cfg.train_config.ml_langs)
    ...
    for (hf_id, k, rcst_hook, sae_width, norm_sae, layer) in product(
